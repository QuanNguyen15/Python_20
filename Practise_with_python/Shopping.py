...
def print_return_infor(total):  # assumption 500 200 100 50 20 10 1
...
def main():
    APPLE_PRICE = 21  # VND
    apple_weight = float(input("Enter weight of apple: "))
    ...
    if money_return == -1:
        ...
        print("\nYou need to return to customer: " + str(round(money_return, 2)))
        print_return_infor(money_return)
